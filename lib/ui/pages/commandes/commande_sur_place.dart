...
class CommandesSurPlacePage extends StatefulWidget {
  const CommandesSurPlacePage({Key? key}) : super(key: key);

  @override
  _CommandesSurPlacePageState createState() => _CommandesSurPlacePageState();
}

class _CommandesSurPlacePageState extends State<CommandesSurPlacePage> {
              ...
              children: [
                ...
                Column(
                  children: const [
                    ...
                    Text("Liste des commandes sur place",
                        style: TextData.subtitlePageStyle)
                  ],
                )
              ],
